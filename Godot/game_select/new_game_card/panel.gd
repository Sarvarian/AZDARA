...
const norm_style : StyleBoxFlat = preload("res://game_select/new_game_card/norm_style.tres")
const hover_style : StyleBoxFlat = preload("res://game_select/new_game_card/hover_style.tres")
