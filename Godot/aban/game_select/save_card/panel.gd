...
const norm_style : StyleBoxFlat = preload("res://aban/game_select/save_card/norm_style.tres")
const hover_style : StyleBoxFlat = preload("res://aban/game_select/save_card/hover_style.tres")
